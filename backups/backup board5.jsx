...
export default function Board({ board, setBoard, boards, setBoards, activeBoardId, members }) {
  ...
  function updateStickerValue(value, closeModal = false) {
    ...
    // Держим selectedSticker.sticker.value в актуальном состоянии,
    // чтобы открытая модалка стикера сразу отражала новое значение.
    setSelectedSticker((prev) =>
      prev
        ? { ...prev, sticker: { ...prev.sticker, value } }
        : prev,
    );
